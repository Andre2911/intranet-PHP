<template>
    <v-card>
                    ...
                    <v-layout wrap>
                        ...
                        <v-flex xs12>
                            <v-btn @click="changePersonaFisica()">
                                <v-icon v-if="activeItem.id != undefined && activeItem.ocupado_caf.length > 0" color="primary">mdi-refresh</v-icon>
                                <v-icon v-else >mdi-magnify</v-icon>
                                <v-icon>mdi-account</v-icon>
                                <template v-if="activeItem.id != undefined && activeItem.ocupado_caf.length > 0">
        ...
        <v-dialog v-model="d_persona_f"
            ...
            max-width="1200PX"
            transition="dialog-transition">
            <select-persona-component @selectedItem="selectedItemF"/>
        </v-dialog>
