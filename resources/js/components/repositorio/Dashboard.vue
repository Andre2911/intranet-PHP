...
export default {
    ...
    data() {
        return {
            ...
            modulos:[
                {id:1, name:'Laboral - Votos', link:'laboral/votos/', color:'#0277BD', icon:'mdi-file-upload', role:'Repositorio.laboral|Administrador'},
                {id:2, name:'Laboral - Actas', link:'laboral/actas/', color:'#0277BD', icon:'mdi-file-upload', role:'Repositorio.laboral|Administrador'},
            ]
        }
    },
    methods:{
