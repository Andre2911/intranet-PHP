        ...
        <v-main id="contentApp">
            <v-card>
               <v-toolbar color="grey" dark>
                  <v-toolbar-title>Repositorio de la Sala Laboral de Puno :: Votos</v-toolbar-title>
               </v-toolbar>
            </v-card>
...
<script>
   export default {
      ...
      methods:
      {
         getData()
         {
            let urlPlantillas='buscar?init=true';
         ...
         buscarRes(pag = 1){ 
            ...
            if (this.s_especialidad != '' || this.s_materia != '' || this.s_acto != '') {
               ...
               urlResolucion='buscar?modo='+this.modo_busq+'&search=true&buscar='+this.search+'&pag='+pag;
