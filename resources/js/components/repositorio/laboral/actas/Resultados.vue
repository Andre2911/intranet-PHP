            ...
            <template v-for="resolucion in datos" >
               <v-flex xs12 sm12 md12 lg12 v-bind:key="resolucion.id">
                  <v-card >
                                    ...
                                    <v-list-item-title>
                                       <div class="row">
                                          <div class="col-md-3 text-justify">
                                             <b>Expediente {{ resolucion.x_formato }}</b>
                                          </div>
                                       </div>
                                    </v-list-item-title>
                     ...
                     <v-divider></v-divider>
                           <v-card-text>
                              <b> Fecha de Modificación : {{resolucion.f_modificacion_file}} </b>
                              <div class="row">
                                 <div class="col-md-3">
                                    <a :href="'download/'+resolucion.id" target="_blank"><img :src="'../../public/image/microsoft-word.png'" width="70px"  style="border-radius: 10px;" class="ml-4" /></a>
                                    <br>
                                    {{resolucion.r_archivoword}}
                                 </div>
                                 <div class="col-md-9 text-justify">
                                    {{ resumen(resolucion.crawlerword) }}
                                 </div>     
                              </div>
                           </v-card-text>
                  </v-card>
