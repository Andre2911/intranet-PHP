            ...
            <v-container grid-list-md>
                <v-form v-model="valid" ref="form">
                    <v-layout wrap>
                        ...
                        <template v-if="activeItem.roles != undefined">
                            <v-chip  v-for="rol in activeItem.roles" :key="rol.id" color="success">
                                {{rol.name}}
                                <v-icon @click="removeRol(rol)">mdi-cancel</v-icon>
                            </v-chip>
                        </template>
                        <v-chip @click="addRol()" color="primary"><v-icon>mdi-plus</v-icon></v-chip>
        ...
        save(e){
            ...
            if (this.$refs.form.validate()) {
                ...
                if (this.activeItem.id == undefined || this.editedItem < 1){
                    ...
                    axios.post('usuariosApi', this.activeItem)
                        .then(response =>{
