...
<head>
    ...
    <style type="text/css">
        @page { margin-top: 120px; margin-bottom: 50px; margin-left: 40px; margin-right: 50px; }
        header { position: fixed; left: 0px; top: -80px; right: 0px; height: 50px; }
    ...
    <header class="clearfix">
        ...
        <div id="project">
            <div id="project-block">
                <div><span>INTRANET</span> Sistema de Trámite Documentario</div>
