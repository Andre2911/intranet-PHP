    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"> {{ $sub_titulo.'"'.$item->username.'"' }} </li>
            </ol>
        </section>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">{{ $sub_titulo.'"'.$item->username.'"' }}</h3>
                            <div class="box-tools">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="f_cargo" id="f_cargo">
                                                    ...
                                                    @foreach($cargos as $cargo)
                                                        <option value="{{ $cargo->id }}" {{ $cargo->id == $item->cargo_id ? 'selected' : '' }}>{{ $cargo->nombre }}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                    <div class="input-group input-group-sm">
                                                        <input type="text" class="form-control" id="f_numero_documento" name="f_numero_documento" value="{{ $item->persona->numero_documento }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="f_rol" id="f_rol">
                                                    ...
                                                    @foreach($roles as $rol)
                                                        <option value="{{ $rol->id }}" {{ $rol->id == $user_rol->role_id ? 'selected' : '' }}>{{ $rol->name }}</option>
                                                    @endforeach
                                                </select>
                                                @if ($errors->has('f_rol'))
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <input type="text" class="form-control" id="f_email" name="f_email" value="{{ $item->email }}" >
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <input type="text" class="form-control" id="f_usuario" name="f_usuario" value="{{ $item->username }}" >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="f_estado" id="f_estado">
                                                    ...
                                                    <option value="0" {{ '0' == $item->estado ? 'selected' : '' }}> Inactivo </option>
                                                </select>
